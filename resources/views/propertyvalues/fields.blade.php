...
<div class="form-group col-sm-6">
    ...
    {!! Form::number('indiv1', null, ['class' => 'form-control']) !!}
</div>

<!-- Indiv2 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('indiv2', 'Indiv2:') !!}
    {!! Form::number('indiv2', null, ['class' => 'form-control']) !!}
</div>

<!-- Indiv3 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('indiv3', 'Indiv3:') !!}
    {!! Form::number('indiv3', null, ['class' => 'form-control']) !!}
</div>

<!-- Indiv4 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('indiv4', 'Indiv4:') !!}
    {!! Form::number('indiv4', null, ['class' => 'form-control']) !!}
</div>

<!-- Indiv5 Field -->
<div class="form-group col-sm-6">
    {!! Form::label('indiv5', 'Indiv5:') !!}
    {!! Form::number('indiv5', null, ['class' => 'form-control']) !!}
</div>
...
<div class="form-group col-sm-6">
    ...
    {!! Form::text('param3', null, ['class' => 'form-control']) !!}
</div>

<!-- Submit Field -->
<div class="form-group col-sm-12">
    {!! Form::submit('Save', ['class' => 'btn btn-primary']) !!}
    <a href="{!! route('propertyvalues.index') !!}" class="btn btn-default">Cancel</a>
</div>
