...
<div class="form-group col-sm-12">
    ...
    <a href="{!! route('relinmp.expinmuindex',$inmuid) !!}" class="btn btn-default">Cancelar</a>
</div>

<!-- Persona Id Field -->
<div class="form-group col-sm-6">
    {!! Form::label('persona_id', 'Persona Id:',['style'=>'visibility:hidden']) !!}
    {!! Form::text('persona_id', $personaInmueble->persona_id, ['class' => 'form-control','style'=>'visibility:hidden']) !!}
</div>
