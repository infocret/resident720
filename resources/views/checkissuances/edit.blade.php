...
@section('content')
   ...
   <div class="content">
       ...
       <div class="box box-primary">
           <div class="box-body">
               <div class="row">
                   {!! Form::model($checkissuance, ['route' => ['checkissuances.update', $checkissuance->id], 'method' => 'patch']) !!}

                        @include('checkissuances.emitfields')
...
@section('scripts')
    ...
    <script src="{{ url('/js/numtoleters.js') }}"></script>
@endsection
