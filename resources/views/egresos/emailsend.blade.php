...
@section('content')
    <section class="content-header">
        <h1 class="pull-left"> Enviar correo de Estado de Cuenta de Egresos y anexar PDF </h1>

        <h1 class="pull-right">
        <a class="btn btn-primary pull-right" 
        style="margin-top: -10px;margin-bottom: 5px; margin-left: 10px" 
        href="{!! route('egresos.indexd', [$hmoveid]) !!}" >Volver</a>
        </h1>
    ...
    <div class="content">
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">                   
                    {!! Form::open(['route' => 'egresos.sendrecipmail',
                    'method'=>'post']) !!}  
                     <div class="clearfix"></div>
                          ...
                          <div class="form-group col-sm-2">
                           ...
                           <div class="form-group col-sm-4">
                            ...
                            {!! Form::text('tmsg', $mailhead->tmsg, ['class' => 'form-control',
                                'required' => 'required']) !!}  
                            {!! Form::text('thid', $hmoveid, ['class' => 'form-control',
