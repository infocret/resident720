...
@section('content')
    <section class="content-header">
        ...
        <h1 class="pull-left">Estado de Cuenta Proveedor</h1>
       ...
       @if ($exists)
        ...
        @else   
          ...
          <h1 class="pull-right">
             <a class="btn btn-primary pull-right" 
             style="margin-top: -10px;margin-bottom: 5px; margin-left: 10px" 
             href="{!! route('egresos.showpdf', [$charge->chrid,0]) !!}" target="blank" >
              Ver PDF
             </a>
          </h1> 
          ...
          <h1 class="pull-right">  
              <a class="btn btn-primary pull-right" 
             style="margin-top: -10px;margin-bottom: 5px; margin-left: 10px" 
             href="{!! route('egresos.showpdf', [$charge->chrid,1]) !!}">Descargar PDF</a>
          </h1>        
        ...
        <h1 class="pull-right">
           <a class="btn btn-primary pull-right" 
           style="margin-top: -10px;margin-bottom: 5px; margin-left: 10px" 
           href="{!! route('egresos.mailpdf', [$charge->chrid]) !!}">Enviar PDF por Correo</a>
        </h1>     
