...
<div class="form-group">
    ...
    <p>{!! $headmov->created_at !!}</p>
</div>

<!-- Updated At Field -->
<div class="form-group">
    {!! Form::label('updated_at', 'Updated At:') !!}
    <p>{!! $headmov->updated_at !!}</p>
</div>
