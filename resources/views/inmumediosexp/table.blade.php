<table class="table table-responsive" id="medioPersonas-table">
    ...
    @foreach($inmumedios as $inmumedio)
        <tr>
            ...
            <td>
                {!! Form::open(['route' => ['inmumediosexp.destroy',$inmumedio->id,$inmuid], 'method' => 'delete']) !!}
                <div class='btn-group'>
                    
                <a href="{!! route('inmumediosexp.show', [$inmumedio->id,$inmuid]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-eye-open"></i></a>

                  <a href="{!! route('inmumediosexp.edit', 
                  [$inmumedio->id,$inmuid]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a> 
