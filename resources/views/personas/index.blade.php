...
@section('content')
 ...
 {!! Form::close() !!}
        ...
        <h1 class="pull-right">
           ...
           href="{!! route('personas.create') !!}">Agregar</a>
           @if (Auth::user()->name == "Julio buendia")
           <a class="btn btn-primary pull-right" style="margin-top: -10px;margin-bottom: 5px" href="{!! route('personasimport.index') !!}">Importar</a>
           @endif
        </h1>
