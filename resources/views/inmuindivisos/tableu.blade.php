...
<table class="table table-responsive" id="propertyvalues-table">
    ...
    <tbody>
    @foreach($uindivisos as $propertyvalue)
        <tr>           
           ...
           {{--  <td>              
                <div class='btn-group'>                   
                    <a href="{!! route('indivisos.edit', [$propertyvalue->id,$inmuid]) !!}" class='btn btn-default btn-xs'><i class="glyphicon glyphicon-edit"></i></a>              
                </div>
            </td> --}}
        </tr>
    @endforeach
