        ...
        <!-- Content Wrapper. Contains page content -->
              ...
              <section class="content-header">
                    <h1>                                          
                         ...
                         {!! Session::get('condonomexp') !!} - {!! $inmuDir->nombre !!} - 
                         <img src="{{"box/imginmu/inmuid.png" }}" width="60">                        
                    </h1>
                </section> 
        <!-- dir Field -->
  <div id="dirdiv" class="form-group">
      {!! Form::label('dir', 'Dirección:',['id'=>'dirl']) !!}
      {{-- {!! Form::label('dird', $inmuDir->dir,['id'=>'dird']) !!} --}}
        <p>{!! $inmuDir->dir !!}</p> 
  </div>
...
<tr>       
  <td>
      ...
      <div class="form-group">
         ...
         {{--  {!! Form::label('ref1d', $inmuDir->referencia1,['id'=>'ref1d']) !!} --}}
           <p>{!! $inmuDir->referencia1 !!}</p> 
  ...
  <div class="form-group">
    ...
    {{--   {!! Form::label('ref2d', $inmuDir->referencia2 ,['id'=>'ref2d']) !!} --}}
       <p>{!! $inmuDir->referencia2 !!}</p> 
  </div>
  </td>
</tr>
...
<tr>
  ...
  <div class="form-group">
      ...
      {{-- {!! Form::label('obsd',$inmuDir->observaciones,['id'=>'obsd']) !!} --}}
       <p>{!! $inmuDir->observaciones !!}</p> 
  </div>
  </td>
  ...
  <div>
    ...
    @if (is_null($inmuDir->linkmapa) || $inmuDir->linkmapa == "N/A" || $inmuDir->linkmapa == "n/a")
      <a href="{!!  env('Gmaps_Search2').$inmuDir->dir !!}" class='btn btn-default btn-xs' target="_blank">
      Link a Mapa
      </a>    
    @else
...
<!-- Imagenmapa Field -->
<div>  
  @if (is_null($inmuDir->imagenMapa) || $inmuDir->imagenMapa == "N/A" || $inmuDir->imagenMapa == "n/a")
     <img src="img/sinmapa.png" height="85" width="200" alt="imgsmap"/>
  @else
     <img src="{{ "box/imgmaps/".$inmuDir->imagenMapa }}" 
